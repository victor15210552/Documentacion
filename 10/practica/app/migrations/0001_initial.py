    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Capitan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Capitan')),
            ],
        ),
        migrations.CreateModel(
            name='ExamenChunin',
            fields=[
                ...
                ('slug', models.SlugField(max_length=30, unique=True)),
                ('Equipos', models.ManyToManyField(to='app.Equipo')),
            ],
        ),
        migrations.CreateModel(
            name='Heroe',
        ...
        migrations.AddField(
            model_name='equipo',
            name='Genins',
            field=models.ManyToManyField(to='app.Ninja'),
        ),
    ]
